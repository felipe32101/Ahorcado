  ...
  <section>
    <div v-if="temas" id="">
      ...
      <div v-else style="display: flex; flex-direction: column; gap: 35px;">
        <h1 style="color: rgb(253, 239, 214); font-size: 100px; font-family: fantasy; margin: 0;" v-if="!dificultadSeleccionada">Selecciona una
          dificultad</h1>
        <div
    ...
    <div v-else id="inicio">
      ...
      <button id="jugar" @click="iniTemas">Jugar</button>
    </div>
  </section>
</template>
...
section {
  ...
  width: 100%;
  min-height: 100vh;
  background: linear-gradient(rgb(250, 189, 74), rgb(34, 34, 150));
}
